        ...
        <div class="flex items-center bg-white justify-center mb-10 mt-2 rounded dark:bg-gray-800">
            <div class="w-full flex flex-wrap md:flex-nowrap">
                <div class="w-48 flex flex-wrap md:flex-nowrap">
                    <a href="{{ route('notifikasi-add') }}" class="focus:outline-none text-white bg-komplementer hover:bg-opacity-80 focus:ring-1 focus:ring-komplementer font-medium rounded-full w-full text-sm px-8 py-2.5 mb-2 whitespace-nowrap text-center">
                        Tambah Notifikasi
                    </a>
                </div>
                <div class="w-48 flex flex-wrap md:flex-nowrap ms-2">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-popup hover:bg-opacity-50 dark:bg-gray-800">
                            ...
                            <td class="p-1 text-center text-base text-center text-black border-x border-secondary">
                                {{ $item->pesan }}
                            </td>
                            <td class="p-1 text-center whitespace-nowrap text-base text-center text-black border-x border-secondary">
                                {{ $item->tipe_notif }}
