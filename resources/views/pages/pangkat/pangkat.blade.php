        ...
        <div class="flex items-center bg-white justify-center mb-10 mt-2 rounded dark:bg-gray-800">
            <div class="w-full flex flex-wrap md:flex-nowrap">
                <div class="w-48 flex flex-wrap md:flex-nowrap">
                    <a href="{{ route('pangkat-add') }}" class="focus:outline-none text-white bg-komplementer hover:bg-opacity-80 focus:ring-1 focus:ring-komplementer font-medium rounded-full w-full text-sm px-8 py-2.5 mb-2 whitespace-nowrap text-center">
                    Tambah Pangkat
                    </a>
                </div>
            </div>
                        ...
                        <tr class="bg-popup hover:bg-opacity-50 dark:bg-gray-800">
                            ...
                            <td class="px-1 py-1 text-black border-x border-secondary">
                                <div class="flex justify-center gap-4">
                                    ...
                                    <a href="{{ route('pangkat-edit', $pangkat->kd_pangkat) }}">
                                    ...
                                    {{-- <a href="{{ route('pangkat-delete', $pangkat->kd_pangkat) }}">
