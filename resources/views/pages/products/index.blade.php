        ...
        <div class="flex items-center bg-white justify-center mb-10 mt-2 rounded dark:bg-gray-800">
            <div class="w-full flex flex-wrap md:flex-nowrap">
                <div class="w-48 flex flex-wrap md:flex-nowrap">
                    <a href="{{ route('product-add-index') }}" class="focus:outline-none text-white bg-komplementer hover:bg-opacity-80 focus:ring-1 focus:ring-komplementer font-medium rounded-full w-full text-sm px-8 py-2.5 mb-2 whitespace-nowrap text-center">
                    Tambah Produk Baru
                    </a>
                </div>
                <div class="w-48 flex flex-wrap md:flex-nowrap lg:ms-2">
                    <a href="{{ route('gudang-utama-stok-add') }}" class="focus:outline-none text-white bg-komplementer hover:bg-opacity-80 focus:ring-1 focus:ring-komplementer font-medium rounded-full w-full text-sm px-8 py-2.5 mb-2 whitespace-nowrap text-center">
                    Tambah Stok Gudang
                    </a>
                </div>
            </div>
        ...
        <div class="h-full dark:bg-gray-800">
            <div class="relative w-full overflow-x-auto scrollbar-thinner pr-2 pb-1">
                ...
                <thead class="text-xs md:text-sm text-white uppercase bg-secondary dark:bg-gray-700 dark:text-gray-400 sticky top-0 z-10">
                    <tr>
                        <th scope="col" class="p-3 whitespace-nowrap text-center text-white border-x border-secondary">
                        ...
                        <th scope="col" class="p-3 whitespace-nowrap text-center text-base text-white border-x border-secondary">
                            ID Produk
                        </th>
                        <th scope="col" class="p-3 whitespace-nowrap text-center text-base text-white border-x border-secondary">
                            Nama
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr class="bg-popup hover:bg-opacity-50 dark:bg-gray-800">
                            <td class="p-1 whitespace-nowrap text-center text-black border-x border-secondary">
                                <div class="flex items-center justify-center">
                            ...
                            <td class="p-1 whitespace-nowrap text-center text-base text-black border-x border-secondary uppercase">
                                {{ $product->category_poin }}
                            </td>
                            ...
                            <td class="px-1 py-1 text-black border-x border-secondary">
                                <div class="flex justify-center gap-4">
                                    <a href="{{ route('product-detail-index', $product->kd_product) }}">
                                    ...
                                    <a href="{{ route('product-edit-index', $product->kd_product) }}">
                                    ...
                                    <a href="{{ route('product-delete-index', $product->kd_product) }}">
