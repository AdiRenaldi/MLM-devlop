        ...
        <div class="flex items-center bg-white justify-center mb-10 mt-2 rounded dark:bg-gray-800">
            <div class="w-full flex flex-wrap md:flex-nowrap">
                <div class="w-48 flex flex-wrap md:flex-nowrap">
                    <a href="{{ route('pindah-stok-ToGudang') }}" class="focus:outline-none text-white bg-komplementer hover:bg-opacity-80 focus:ring-1 focus:ring-komplementer font-medium rounded-full w-full text-sm px-8 py-2.5 mb-2 whitespace-nowrap text-center">
                        Stok to gudang
                    </a>
                </div>
            </div>
                ...
                <thead class="text-xs md:text-sm text-white uppercase bg-secondary dark:bg-gray-700 dark:text-gray-400 sticky top-0 z-10">
                    <tr>
                        <th scope="col" class="p-3 whitespace-nowrap text-base text-center text-white border-x border-secondary">
                            ...
                            <input id="th-checkbox" type="checkbox" value="" class="w-5 h-5 rounded focus:ring-0 checked:bg-komplementer border-gray-300">
                            </div>
                        </th>
                        <th scope="col" class="p-3 whitespace-nowrap text-base text-center text-white border-x border-secondary">
                            ID Transaksi
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-popup rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form method="POST" action="{{ route('status-pengiriman-ToGudang') }}">
                        @csrf
                        <input 
                        type="hidden" 
                        id="kd_menageStock"
